...
- ⚠️ **Les deux rails du mode web sont TRANSPARENTS** : il ne reste que leur titre (« MAIN », « NEUTRALISÉES »). Ils portaient chacun un cadre teinté — sur un téléphone en paysage, deux pavés de couleur encadraient le plateau en permanence, et ce qu'il faut lire dans un rail est justement une COULEUR, celle du cadre des cartes. En portrait il n'y a jamais eu ni cadre ni titre : la bande du bas EST la main, la rangée plate au-dessus le cimetière.
