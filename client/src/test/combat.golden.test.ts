...
//
// ⚠️ MISE À JOUR VOLONTAIRE — bascule des vitesses sur le COMPTEUR 0–100.
// Ces scénarios étaient écrits avec une période de déplacement d'UN tick, que
// l'échelle bornée ne permet plus : son plancher est 2 ticks (compteur 100),
// et c'est précisément le bornage qu'elle existe pour poser. Toutes les unités
// se déplacent donc un tick sur deux, et les snapshots ont glissé d'autant —
