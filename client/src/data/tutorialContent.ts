...
export const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    blocks: [
      { kind: 'text', text: "Le combat se résout tout seul : tu ne contrôles rien une fois qu'il est lancé. Ce sont ces cinq valeurs — et ton placement — qui décident du résultat." },
      { kind: 'table', head: ['Statistique', 'Effet'], rows: [
        ...
        ['Vit. déplacement', "Plus la valeur est haute, plus l'unité avance souvent."],
        ['Vit. attaque', "Plus la valeur est haute, plus l'unité frappe souvent."],
      ...
      { kind: 'note', text: "Dans un même instant de combat, l'ordre d'action ne se lit sur aucun chiffre à part : c'est le **tier le plus haut** qui passe devant, puis la plus grosse **ATK**, puis la meilleure **vitesse de déplacement**." },
